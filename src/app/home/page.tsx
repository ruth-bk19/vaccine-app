...
const HeroSection = styled("div")(({ theme }) => ({
  ...
  background: "linear-gradient(135deg, #3f51b5, #2196f3)", // Gradient background
  color: "#fff",
  textAlign: "center",
  overflow: "hidden",
  position: "relative",
          ...
          <Content>
            <Container maxWidth="md">
              ...
              <Button
                ...
                color="secondary"
                size="large"
                sx={{ mt: 4, animation: `${fadeIn} 1.4s ease`, width: "200px" }} // Fixed width for the button
      ...
      <CTASection>
        <Container maxWidth="md">
          ...
          <Button
            ...
            color="secondary"
            size="large"
            sx={{ mt: 4, width: "200px" }} // Fixed width for the button
            onClick={handleGetStartedClick}
          >
            Sign Up Now
          </Button>
